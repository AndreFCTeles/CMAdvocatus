      ...
      <div className="hero md:h-[44px]">
         <div className='hero__data flex gap-x-5 flex-wrap'>
            <div className='hero__data__contact m-0 md:mr-10 shrink-0'>
               ...
               <span className='font-bold hidden sm:inline text-sm'>Telefone:</span>{loading ? <div className="heroLoader" /> : <span className='font-medium text-sm'>&nbsp;{formattedTel}</span>}
            </div>
            <div className='hero__data__contact shrink-0'>
               ...
               <span className='font-bold hidden sm:inline text-sm'>E-Mail:</span>{loading ? <div className="heroLoader" /> : <span className='font-medium text-sm'>&nbsp;{dados?.email || "Default E-Mail"}</span>}
            </div>
         </div>
