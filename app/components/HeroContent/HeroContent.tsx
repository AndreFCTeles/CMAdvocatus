...
const HeroContent: React.FC<PropType> = ({tel, email}) => {
   return (
      <div className="hero">
         <div className='hero__data flex gap-x-5'>
            <p className='hero__data__contact m-0 md:mr-10 shrink-0'>
               ...
               <span className='font-bold hidden sm:inline text-sm'>Telefone:</span><span className='font-medium text-sm'>&nbsp;{tel}</span>
            </p>
            <p className='hero__data__contact shrink-0'>
               ...
               <span className='font-bold hidden sm:inline text-sm'>E-Mail:</span><span className='font-medium text-sm'>&nbsp;{email}</span>
            </p>
         </div>
         
         <button className="py-3 px-10 hidden md:inline-block text-sm" onClick={() => scrollPageToSection("agendar")}>Agendar</button>
      </div>
   )
};
